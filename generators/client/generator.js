    ...
    return this.asDefaultTaskGroup({
      ...
      defaultTemplateTask({ entities }) {
        for (const entity of entities) {
          ...
          const transformSample = value => replaceDayjs(value);

          if (entity.tsSampleWithPartialData) {
            entity.tsSampleWithPartialData = transformSample(entity.tsSampleWithPartialData);
          }
          if (entity.tsSampleWithRequiredData) {
            entity.tsSampleWithRequiredData = transformSample(entity.tsSampleWithRequiredData);
          }
          if (entity.tsSampleWithFullData) {
            entity.tsSampleWithFullData = transformSample(entity.tsSampleWithFullData);
          }
          if (entity.tsSampleWithNewData) {
            entity.tsSampleWithNewData = transformSample(entity.tsSampleWithNewData);
          }
          if (entity.tsPrimaryKeySamples) {
            entity.tsPrimaryKeySamples = entity.tsPrimaryKeySamples.map(transformSample);
          }
        }
      },
    });
