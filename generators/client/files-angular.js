...
const { replaceAngularTranslations } = require('generator-jhipster/generators/client/transform-angular.cjs');

const { CLIENT_MAIN_SRC_DIR, CLIENT_TEST_SRC_DIR, ANGULAR_DIR } = constants;
const { OAUTH2, SESSION, JWT } = require('generator-jhipster/jdl/jhipster/authentication-types.js');
const { GATEWAY } = require('generator-jhipster/jdl/jhipster/application-types.js');
const { SPRING_WEBSOCKET } = require('generator-jhipster/jdl/jhipster/websocket-types.js');
  ...
  angularCore: [
    {
      ...
      templates: [
        ...
        'core/request/lazy-subscriber.ts',
      ],
    },
    {
