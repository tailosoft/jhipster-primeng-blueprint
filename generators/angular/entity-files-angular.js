...
import { filterEntitiesAndPropertiesForClient, filterEntitiesForClient } from 'generator-jhipster/generators/client/support';
...
export const writeEntitiesFiles = async function ({
  application,
  entities,
}) {
...
export const postWriteEntitiesFiles = async function (_, taskParam) {
...
export const cleanupEntitiesFiles = function ({
  application,
  entities,
  control,
}) {
