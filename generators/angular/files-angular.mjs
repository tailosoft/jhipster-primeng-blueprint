  ...
  angularCore: [
    {
      ...
      templates: [
        ...
        // config
        'config/dayjs.ts', // not used be kept here, since language expect it, we can create an issue for, different generators should check for file existence before changing
