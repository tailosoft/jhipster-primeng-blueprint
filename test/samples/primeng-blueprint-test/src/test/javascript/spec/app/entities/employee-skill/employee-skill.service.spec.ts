...
describe('Service Tests', () => {
  describe('EmployeeSkill Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a EmployeeSkill', async () => {
      ...
      it('should update a EmployeeSkill', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            level: 1
      ...
      it('should return a list of EmployeeSkill', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            level: 1
