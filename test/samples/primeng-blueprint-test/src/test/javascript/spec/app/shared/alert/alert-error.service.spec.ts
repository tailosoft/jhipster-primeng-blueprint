...
describe('Component Tests', () => {
  describe('Alert Error Component', () => {
    let service: JhiAlertErrorService;
    let messageService: MessageService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [PrimengtestTestModule, TranslateModule.forRoot()],
        providers: [JhiAlertErrorService, MessageService]
      });
      service = TestBed.get(JhiAlertErrorService);
